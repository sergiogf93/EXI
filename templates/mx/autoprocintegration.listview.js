<table> 
	<tr><td class='unselectable-text' style='color:#207a7a;font-weight:bold;'>{.v_datacollection_processingPrograms}</td></tr>
	<tr><td class='unselectable-text'>{.v_datacollection_summary_phasing_autoproc_space_group}</td></tr>
	<tr>
