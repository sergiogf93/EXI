                ...
                {#.autoprocessing}
                                    ...
                                    {@gt key=items.length value=0}  
                                                ...
                                                {#.}
                                                    ...
                                                    {#.items}
                                                        <tr> 
                                                            {@eq key=status value="Success"}<td> <span style='color:green;' class="glyphicon glyphicon-ok"></span></td><td>{.name} </td>{/eq}
                                                            {@ne key=status value="Success"} <td> <span style='color:red;' class="glyphicon glyphicon-remove"></span></td><td>{.name} </td> {/ne}
                                                        </tr> 
                                                    {/.items}
                                                    </table>
                                                {/.} 
