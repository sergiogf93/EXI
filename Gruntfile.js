	  ...
	  concat : {
		  prod:{
			  files : {
				 ...
				 'min/bower_components.min.js' 	: ["js/bower_components/dygraphs/dygraph-combined.js", "js/bower_components/handsontable/dist/handsontable.full.js","js/bower_components/jquery/dist/jquery.min.js",
								   "js/bower_components/jquery-lazy/jquery.lazy.js", "js/bower_components/moment/min/moment.min.js"
								],
	  ...
	  cssmin: {
		 prod:{
			  options: {
			    ...
			    files: {
			          'min/exi.min.css': [ 'css/dygraph-custom.css', 'css/exi.css', 'css/calendar.css', 'css/menu/mainmenu.css', 'css/override.css', 'js/bower_components/handsontable/dist/handsontable.full.css', 'js/dependency/timeline/timeline.css']
			    }
		}
	}
