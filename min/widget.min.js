...
/**
 * From an array of json sums all the element[resultParameter] = sum(element[parameter]) for each element
 */
/*GenericDataCollectionPanel.prototype.sum = function(parameter, dataCollectionGroup, resultParameter){
	var sum = 0;
	for (var i = 0; i < dataCollectionGroup.length; i++) {
		sum = sum + Number(dataCollectionGroup[i][parameter]);
	}
	for (var i = 0; i < dataCollectionGroup.length; i++) {
		dataCollectionGroup[i][resultParameter] = sum;
	}
	return sum;
};
*/
...
OSC_MxPressE_DataCollectionPanel.prototype.getColumns = function() {
	var _this = this;
	var columns = [
	{
		header : 'Type',
...
OSC_MxPressE_DataCollectionPanel.prototype.load = function(dataCollectionGroup){
	//this.store.loadData(this.summarize(dataCollectionGroup));
	var summary = this.summarize(dataCollectionGroup);
	this.store.loadData([summary]);
