...
PuckPanel.prototype.renderAsSpine = function(puck) {
	/** Rendering layout **/
	document.getElementById(this.id).innerHTML = "";
...
PuckPanel.prototype.renderEmptyPlateWell = function(canvas, x, y, label) {
	var s = Snap(canvas);
...
PuckPanel.prototype.renderEmptyWell = function(canvas, x, y, label) {
	var s = Snap(canvas);
...
PuckPanel.prototype.renderPlateContainer = function(canvas, width, height) {
	var _this = this;
	var s = Snap(canvas);
...
/** To be moved **/
PuckPanel.prototype.renderContainer = function(canvas, centerX, centerY, radius) {
	var _this = this;
	var s = Snap(canvas);
...
PuckPanel.prototype.renderPlateWell = function(canvas, x, y, label) {
	var s = Snap(canvas);
	var width = (this.width-40)/12;
	var emptyWell = s.rect(x,y, width, width);
	emptyWell.attr({
...
PuckPanel.prototype.renderWell = function(canvas, x, y, label) {
	var s = Snap(canvas);
	var radius = this.width/12;
...
PuckPanel.prototype.renderAsPlate = function(puck) {
	/** Rendering layout **/
	document.getElementById(this.id).innerHTML = "";
	document.getElementById(this.id).setAttribute("width", this.width);
	document.getElementById(this.id).setAttribute("height", this.height);
...
PuckPanel.prototype.renderAsUnipuck = function(puck) {
	/** Rendering layout **/
	document.getElementById(this.id).innerHTML = "";
	document.getElementById(this.id).setAttribute("width", this.width);
	document.getElementById(this.id).setAttribute("height", this.height);
