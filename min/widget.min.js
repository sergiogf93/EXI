...
DataCollectionSummaryGrid.prototype.load = function(data) {	
	...
	for ( var i in datasets) {
		...
		var dataCollectionGroupFactory = new DataCollectionGroupFactory();
		this.panel.add(dataCollectionGroupFactory.getPanel(dataset));
		dataCollectionGroupFactory.load(dataset);
	}
