...
GenericDataCollectionPanel.prototype.getColumns = function() {
	...
	},
	{
		...
		renderer : function(grid, e, record){
			...
			/*return _this.getHTMLTable([
			                           {key : "processingPrograms", value : record.data.processingPrograms},
			                           {key : "processingStatus ", value : record.data.processingStatus},
			                           {key : "sdfs ", value : JSON.stringify(_this.parseResults(record.data.processingPrograms, record.data.processingStatus))}
			]);*/
		}
	},
	{
