...
SamplesGrid.prototype.load = function(crystal) {
	...
	this.crystal = crystal;	
	this.store.loadData(this.getSampleList());
...
SamplesGrid.prototype.getSampleList = function() {
	function f(sender, data){
		debugger
		
	}
	EXI.getDataAdapter({onSuccess: f}).mx.sample.getSamplesByCrystalId(this.crystal.crystalId);
	
	//this.samples = sampledataadapter.getSamplesByCrystalId(this.crystal.crystalId);
	//return this.samples;
};
