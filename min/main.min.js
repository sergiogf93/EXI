...
function ImageMainView() {
	...
	this.imageViewer = new ImageResolutionVieewr();
}
...
ImageMainView.prototype.load = function(imageId, dataCollectionId) {
	...
	/*document.getElementById(this.id + "img").setAttribute("src", url);
	document.getElementById(this.id + "img").setAttribute("height", 500);
	document.getElementById(this.id + "img").setAttribute("width", 500);*/
